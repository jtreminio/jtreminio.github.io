...
aliases: /2012/04/getting-started-with-kohana-3-part-iii-controller-mvvm-kostache
tags:
    - webdev
    - kohana
    - tutorial
...
`{% block %}`, but it still sometimes felt like too much logic
...
{{< imgproc "kohana.kostache.png" Resize "300x" />}}
